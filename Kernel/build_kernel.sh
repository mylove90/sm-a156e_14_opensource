...
cd kernel-5.15
python2 scripts/gen_build_config.py --kernel-defconfig a15x_00_defconfig --kernel-defconfig-overlays "entry_level.config" -m user -o ../out/target/product/a15x/obj/KERNEL_OBJ/build.config
